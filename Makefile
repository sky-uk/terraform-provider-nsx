terraform-provider-nsx: config.go main.go provider.go resource_logical_switch.go resource_edge_interface.go resource_dhcp_relay.go resource_service.go resource_security_group.go resource_security_tag.go
